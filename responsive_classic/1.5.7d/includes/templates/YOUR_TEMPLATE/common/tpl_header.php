 ...
 * @version $Id: dbltoe 2023 Oct 5 Modified in v1.5.7d $
 */
?>
...
<div id="navMain">
  <ul class="back">
    <li><?php echo '<p class="tradeMark">' . HEADER_TITLE_TRADEMARK . '</p><a href="' . HTTP_SERVER . DIR_WS_CATALOG . '">'; ?><?php echo HEADER_TITLE_CATALOG; ?></a></li>
<?php
    if (zen_is_logged_in() && !zen_in_guest_checkout()) {
?>
    <li><a href="<?php echo zen_href_link(FILENAME_LOGOFF, '', 'SSL'); ?>"><?php echo HEADER_TITLE_LOGOFF; ?></a></li>
