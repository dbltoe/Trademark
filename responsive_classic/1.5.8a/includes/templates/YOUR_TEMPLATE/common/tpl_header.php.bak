 ...
 * @version $Id: dbltoe 2023 Oct 05 Modified in v1.5.8-alpha $
 */
?>
...
<div id="navMain">
  <ul>
    <li><?php echo '<p class="tradeMark">' . HEADER_TITLE_TRADEMARK . '</p><a href="' . HTTP_SERVER . DIR_WS_CATALOG . '">'; ?><i class="fa fa-home" title="Home"></i></a></li>
