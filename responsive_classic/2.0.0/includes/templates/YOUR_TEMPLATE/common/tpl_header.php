 ...
 * @version $Id: dbltoe 2023 Oct 05 Modified in v2.0.0 beta $
 */
?>
...
if ($detect->isMobile() && !$detect->isTablet() || $_SESSION['layoutType'] == 'mobile') {
    echo '<div class="header Fixed"><a href="#menu" title="Menu"><i class="fa-solid fa fa-bars"></i></a><p class="tradeMark">' . HEADER_TITLE_TRADEMARK . '</p></div>';
...
<div id="navMain">
  <ul>
    <li><?php echo '<p class="tradeMark">' . HEADER_TITLE_TRADEMARK . '</p><a href="' . HTTP_SERVER . DIR_WS_CATALOG . '">'; ?><i class="fa-solid fa-house" title="Home"></i></a></li>
